...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        for _ in range(len(formals)):
            child_frame.define(ptr1.first, ptr2.first)
            ptr1, ptr2 = ptr1.rest, ptr2.rest 
        return child_frame
        # END PROBLEM 10
...
def make_let_frame(bindings, env):
    ...
    while ptr is not nil:
        ...
        values = Pair(scheme_eval(ptr.first.rest.first, env), values)
        ptr = ptr.rest
