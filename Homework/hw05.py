...
def is_bst(t):
    ...
    if t.is_leaf():
        ...
        b = t.branches[0]
        return is_bst(b) and (t.label >= bst_max(b) or t.label < bst_min(b))
    else:
        b1, b2 = t.branches[0], t.branches[1]
        return is_bst(b1) and is_bst(b2) and t.label >= bst_max(b1) and t.label < bst_min(b2)
